...
activities = {
    ...
    "Robotics Team": {
        ...
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "isabella@mergington.edu", "mason@mergington.edu"]
    },
    "Book Club": {
        "description": "Read and discuss a diverse selection of fiction and non-fiction books",
